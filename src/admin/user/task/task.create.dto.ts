 ...
 * @LastEditTime: 2026-02-11 23:16:52
 * @FilePath: /card-auto-planning/src/plan/user/plan/plan.create.dto.ts
 * @Description: 这是默认设置,请设置`customMade`, 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 */
import { TaskAnnexType, TaskStatus, TaskTimingType, UserTaskScheduler } from '@prisma/client';
import {Expose, Type} from 'class-transformer';

export class AdminUserTaskCreateDto {
